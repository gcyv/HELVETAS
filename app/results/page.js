...
const ResultPage = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start min-h-screen bg-white pb-16 space-y-8 overflow-x-hidden">
      ...
      <div className="absolute top-14 left-36 w-full max-w-screen-lg mx-auto text-[#003366]">
        <div className="w-full flex justify-between">
          <Menubar className="bg-white shadow-md rounded-md w-full max-w-[12rem]">
            <MenubarMenu>
              <MenubarTrigger>All Time</MenubarTrigger>
              <MenubarContent className="w-48 text-[#003366]">
            ...
            <MenubarMenu>
              ...
              <MenubarContent className="w-56 text-[#003366]">
      ...
      <div className="absolute top-32 left-36 max-w-7xl w-full px-6 py-8 bg-white shadow-lg rounded-lg">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center justify-end space-x-4">
            <Pagination className="flex justify-center items-center space-x-3">
              <PaginationPrevious className="px-4 py-2 bg-[#003366] text-white rounded-lg shadow-md cursor-pointer hover:bg-[#a23f33] hover:text-white transition-all duration-300 ease-in-out">
                Previous
              </PaginationPrevious>

              <PaginationContent className="flex space-x-2">
                <PaginationItem>
                  <PaginationLink className="px-3 py-2 bg-gray-200 rounded-lg text-[#003366] cursor-pointer hover:bg-blue-100 transition-all duration-200 ease-in-out">
                    1
                  </PaginationLink>
                </PaginationItem>
                <PaginationItem>
              ...
              <PaginationNext className="px-4 py-2 bg-[#003366] text-white rounded-lg shadow-md cursor-pointer hover:bg-[#a23f33] hover:text-white transition-all duration-300 ease-in-out">
                Next
              </PaginationNext>
            </Pagination>
          </div>
        ...
        <h3 className="text-lg font-semibold mb-6 text-[#003366]">Innovation Strategy</h3>
        <p className="text-[#003366] mb-8 text-m">
